...
//		mbs.invoke(httpon, "startListener", new Object[] {}, new String[] {});
	...
	public static void configureMonitor(MBeanServer mbs, ObjectName rson)
		...
		spmal.add(
			new Attribute("ObservedObject", new ObjectName("todd:id=SessionPool")));
		...
		mbs.invoke(
			rson,
			"createRelation",
			new Object[] { "todd.sessionpool", "SessionPool", sprl },
			new String[] {
				"java.lang.String",
				"java.lang.String",
				"javax.management.relation.RoleList" });
				
		RoleResult rr = (RoleResult) mbs.invoke(rson, "getAllRoles", new Object[] { "todd.sessionpool" }, new String[] { "java.lang.String" });
	...
	public static void createRelationType(MBeanServer mbs, ObjectName rson)
		throws
			MalformedObjectNameException,
			MBeanException,
			MBeanRegistrationException,
		...
		sproles[1] =
			new RoleInfo(
				...
				null);
		sproles[2] =
			new RoleInfo("timer", "javax.management.timer.Timer", false, false, 0, 1, null);
		mbs.invoke(
			rson,
			"createRelationType",
			new Object[] { "SessionPool", sproles },
	...
	public void handleNotification(Notification n, Object hb) {
		...
		if (type.compareTo(MonitorNotification.THRESHOLD_LOW_VALUE_EXCEEDED) == 0) {
			...
			type.compareTo(MonitorNotification.THRESHOLD_HIGH_VALUE_EXCEEDED) == 0) {
			if (isActive() == false)
				start();
		}
	}
